...
#' 
#' @description
#' Fetch Google Analytics data using the v4 API.  For the v3 API use [google_analytics_3], for GA4's Data API use [ga_data].  See website help for lots of examples: [Google Analytics Reporting API v4 in R](https://code.markedmondson.me/googleAnalyticsR/articles/v4.html)
#' 
#' 
